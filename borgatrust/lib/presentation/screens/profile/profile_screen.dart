...
import '../../../shared/widgets/custom_text_field.dart'; // Import CustomTextField for editable fields
...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  void _saveChanges() {
    ...
    setState(() {
      ...
      // Update the UserService with new data
      final updates = {
      ...
      if (_userService.currentUserRole == UserRole.serviceAgent) {
        updates['businessName'] = _businessNameController.text;
      }
      
      _userService.updateUserData(updates);
            ...
            children: [
              CircleAvatar(
                ...
                backgroundImage: _userData["avatarUrl"] != null && _userData["avatarUrl"].isNotEmpty
                               ...
                               : null,
                onBackgroundImageError: _userData["avatarUrl"] != null && _userData["avatarUrl"].isNotEmpty
